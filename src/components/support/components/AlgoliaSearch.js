...
export class AlgoliaSearch extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    const hasDefaultSearchTextChanged =
      prevProps.defaultSearchText !== this.props.defaultSearchText;
  ...
  refineSearch() {
    const nextSearchText =
      this.state.searchText.trim() === '' ? this.props.defaultSearchText : this.state.searchText;
