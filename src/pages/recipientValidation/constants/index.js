export const ROLE_TOOLTIP = 'Role email addresses represent a group or activity (sales, abuse) \
  and not an individual. They\'re not considered opt-in and are abused by \
  web-scraping tactics. They tend to have a lower engagement rate and a higher unsubscribe rate.';
