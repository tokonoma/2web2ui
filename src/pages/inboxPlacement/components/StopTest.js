  ...
  return (
    <>
      <ConfirmationModal
        ...
        content={
          <p>
            By stopping this test no additional data will be gathered. You will not be able to
            restart test after stopping.
          </p>
        }
        onConfirm={stopTest}
      ...
      />
      <Button primary size="large" onClick={toggleModalVisibility}>
        Stop Test
      </Button>
    </>
  );
