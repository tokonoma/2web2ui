...
const HeaderComponent = () => (
  <thead>
    <Table.Row className={styles.HeaderRow}>
      ...
      <Table.HeaderCell className={classnames(styles.HeaderCell, styles.LeftBorder)}>
        Headers
      </Table.HeaderCell>
    </Table.Row>
  </thead>
...
const WrapperComponent = ({ children }) => <Table>{children}</Table>;
    ...
    return (
      <>
        <Table.Row className={classnames(styles.DataRow, isHeaderRowOpen && styles.NoBottomBorder)}>
          ...
          <Table.Cell
            className={classnames(styles.Authentication, !isHeaderRowOpen && styles.LeftBorder)}
          >
