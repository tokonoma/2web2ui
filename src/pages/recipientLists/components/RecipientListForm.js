...
import exampleRecipientListPath2 from './example-recipient-list2.csv';
...
export class RecipientListForm extends Component {
  ...
  // `csv` is an internal field. The outer component can access the parsed records in `recipients`.
          ...
          <Panel>
            <Panel.Section>
              ...
              <Field
                ...
                helpText={
                  <span>
                    Download a .csv template to use when formatting your recipient list for
                    upload:&nbsp;
                    <DownloadLink href={exampleRecipientListPath2}>column format</DownloadLink>{' '}
                    (recommended) or&nbsp;
                    <DownloadLink href={exampleRecipientListPath}>JSON format</DownloadLink>.
                  </span>
                }
                label={uploadHint}
                name="csv"
