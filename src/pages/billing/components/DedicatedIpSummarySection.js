...
export default function DedicatedIpSummarySection({ count = 0, plan = {}, onClick = noop, isAWSAccount, isUsageBlocked }) {
  ...
  const actions = isUsageBlocked ? [manageIpAction] : [manageIpAction, addOrUpgradeAction];
