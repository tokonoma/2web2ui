...
import OGStyles from './FromEmail.module.scss';
import hibanaStyles from './FromEmailHibana.module.scss';
 ...
 */
export class FromEmailClassComponent extends Component {
  state = {
    matches: [],
  };
  ...
  render() {
    const { value, styles, ...inputProps } = this.props;
...
export default function FromEmail(props) {
  const styles = useHibanaOverride(OGStyles, hibanaStyles);

  return <FromEmailClassComponent styles={styles} {...props} />;
}
